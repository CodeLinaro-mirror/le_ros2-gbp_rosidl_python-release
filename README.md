## rosidl_python (rolling) - 0.28.0-1

The packages in the `rosidl_python` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling rosidl_python` on `Tue, 05 May 2026 17:32:23 -0000`
...
- rosdistro version: `0.27.2-2`
- old version: `0.27.2-2`
...
## rosidl_python (rolling) - 0.27.2-1

The packages in the `rosidl_python` repository were released into the `rolling` distro by running `/usr/local/google/home/sloretz/projects/lyrical/env3/bin/bloom-release rosidl_python --rosdistro rolling --track rolling` on `Tue, 14 Apr 2026 05:01:48 -0000`
...
## rosidl_python (rolling) - 0.27.1-1

The packages in the `rosidl_python` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling rosidl_python` on `Thu, 09 Apr 2026 13:29:41 -0000`
...
## rosidl_python (rolling) - 0.27.0-1

The packages in the `rosidl_python` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling rosidl_python` on `Tue, 03 Mar 2026 17:20:37 -0000`
...
## rosidl_python (rolling) - 0.26.3-1

The packages in the `rosidl_python` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling rosidl_python` on `Mon, 12 Jan 2026 14:30:27 -0000`
...
## rosidl_python (rolling) - 0.26.2-1

The packages in the `rosidl_python` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling rosidl_python` on `Tue, 11 Nov 2025 08:43:24 -0000`
...
## rosidl_python (humble) - 0.14.6-1

The packages in the `rosidl_python` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble rosidl_python` on `Mon, 06 Oct 2025 11:23:13 -0000`
...
- upstream repository: https://github.com/ros2/rosidl_python.git
- release repository: https://github.com/ros2-gbp/rosidl_python-release.git
- rosdistro version: `0.14.5-1`
- old version: `0.14.5-1`
- new version: `0.14.6-1`
...
## rosidl_python (jazzy) - 0.22.2-1

The packages in the `rosidl_python` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy rosidl_python` on `Mon, 06 Oct 2025 11:15:25 -0000`
...
## rosidl_python (kilted) - 0.24.2-1

The packages in the `rosidl_python` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted rosidl_python` on `Mon, 06 Oct 2025 11:10:57 -0000`
...
- upstream repository: https://github.com/ros2/rosidl_python.git
- release repository: https://github.com/ros2-gbp/rosidl_python-release.git
- rosdistro version: `0.24.1-2`
- old version: `0.24.1-2`
...
## rosidl_python (rolling) - 0.26.1-1
